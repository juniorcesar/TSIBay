...
VALUES (1, "2013-10-09", "Processador Intel® Celeron® G470 (2.0GHz, 2 Threads, 1.5Mb Cache) - Windows® 7 Home Basic 64-Bit - Memória 2GB, Dual Channel DDR3, 1600MHz (1x2Gb) - Disco Rígido 500GB", "2013-10-10", "Dell", "A Combinar", "Computador Dell Spiron", 0, 5, 2500, 2, 8, 10, 1, 1);
...
INSERT INTO Produto (id, data, descricao, dtLimiteVenda, fabricante, frete, nome, ofertado, prazo, precoVenda, qtdeDisponivel, qtdeVendida, quantidade, familia_id, pessoa_id)
VALUES (3, "2013-10-09", "Processador Intel® Celeron® G470 (2.0GHz, 2 Threads, 1.5Mb Cache) - Windows® 7 Home Basic 64-Bit - Memória 2GB, Dual Channel DDR3, 1600MHz (1x2Gb) - Disco Rígido 500GB", "2013-10-10", "Dell", "Grátis", "Computador Dell Spiron", 0, 5, 2650, 5, 5, 10, 1, 7);

INSERT INTO Produto (id, data, descricao, dtLimiteVenda, fabricante, frete, nome, ofertado, prazo, precoVenda, qtdeDisponivel, qtdeVendida, quantidade, familia_id, pessoa_id)
VALUES (4, "2013-10-09", "3ª Geração do Processador Intel® Core™ i3-3240 (3.4GHz, 4 Threads, 3Mb Cache) - Windows® 7 Home Basic 64-Bit - Memória 4GB, Dual Channel DDR3, 1600MHz (1x4Gb) - Disco Rígido 500GB, SATA (7200 RPM)", "2013-10-10", "Dell", "A Combinar", "Computador Dell Vostro", 0, 5, 2750, 4, 1, 5, 1, 1);

INSERT INTO Produto (id, data, descricao, dtLimiteVenda, fabricante, frete, nome, ofertado, prazo, precoVenda, qtdeDisponivel, qtdeVendida, quantidade, familia_id, pessoa_id)
VALUES (5, "2013-10-09", "3ª Geração do Processador Intel® Core™ i3-3240 (3.4GHz, 4 Threads, 3Mb Cache) - Windows® 7 Home Basic 64-Bit - Memória 4GB, Dual Channel DDR3, 1600MHz (1x4Gb) - Disco Rígido 500GB, SATA (7200 RPM)", "2013-10-10", "Dell", "Grátis", "Computador Dell Vostro", 0, 5, 2850, 1, 4, 5, 1, 2);
